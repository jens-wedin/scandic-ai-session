...
4. **Assess spacing and layout**: Consistent use of spacing tokens? Proper alignment and grid usage?
5. **Review typography**: Correct type scale? Readable line lengths? Proper heading hierarchy?
6. **Check color usage**: On-brand? Sufficient contrast? Meaningful use of color (not as sole indicator)?
7. **Consider responsiveness**: How does this work across breakpoints? Touch targets adequate?
